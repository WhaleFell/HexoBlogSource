...
![](http://pic.lskyl.xyz/blog/Golang/error-1.png)  
...
![](http://pic.lskyl.xyz/blog/Golang/error-4.png)  

#### 调用 `struct` 类型的方法

![](http://pic.lskyl.xyz/blog/Golang/error-5.png)  
...
### 1. 通过 `errors.New("描述")`
![](http://pic.lskyl.xyz/blog/Golang/error-2.png)

### 2. 通过 `fmt.Errorf()`  
也可以使用 `fmt.Errorf()` 输出的错误更详细,支持格式化输出错误.  

![](http://pic.lskyl.xyz/blog/Golang/error-3.png)  
