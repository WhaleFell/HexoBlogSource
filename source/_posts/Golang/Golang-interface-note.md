...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-1.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-2.png)  
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-4.png)  
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-3.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-5.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-7.png)

### 空接口定义任意类型的数据

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-6.png)

### 空接口作为函数的参数

表示函数的参数可以是任意类型,相当于 Python 的 `typing.Any`

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-8.png)  
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-9.png)  
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-10.png)

## 接口嵌套

接口允许多继承.

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-11.png)

如果 Cat 想实现接口 C,不仅要实现接口 C 自己的方法,还要实现接口 C 继承的接口 A B 中的方法.

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-12.png)  
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-13.png)  
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/insterface-14.png)

## 接口断言

前面说过，因为空接口 `interface` 没有定义任何函数，因此 `Go` 中 **所有类型都实现了空接口**。当一个函数的形参是 `interface{}` ，那么在函数中，需要对形参 **进行断言**，从而 **得到它的真实类型**。

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-15.png)
...
![通过x.(T)方式断言](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-16.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/Golang/interface-17.png)

## 接口值

接口值由两部分组成：一个具体的类型（type）和这个类型的值（value）。**接口是动态类型。**一个接口值可以持有任意大的动态值。实现了这个接口的类型都可以赋值这个接口。

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/img/20221229121130.png)
...
![接口的赋值](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/img/20221229122508.png)
...
![一个不包含任何值的 nil 接口值](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/img/20221229121130.png)

一个刚好包含 nil 指针的接口值：

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/img/20221229123705.png)
