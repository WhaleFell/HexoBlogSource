...
**重启无报错则修改成功啦:**  
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152804.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152811.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152818.png)

再次使用普通用户 pi `mysql -u root -p` 即可通过密码登录数据库，无需 root 权限执行:

![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152823.png)
...
1. 打开文件 `sudo nano /etc/mysql/mariadb.conf.d/50-server.cnf`，注释掉 bind-address 项，如下:  
   ![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152829.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152834.png)  
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152851.png)
...
![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152859.png)
...
- 尝试访问 [http://你的树莓派ip/phpmyadmin](http://%E4%BD%A0%E7%9A%84%E6%A0%91%E8%8E%93%E6%B4%BEip/phpmyadmin)  
  ![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152752.png)  
  **启动高级功能** 会新建一个 phpmyadmin 数据库  
  ![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152912.png)  
  **安装成功！**  
  ![](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152920.png)
...
- 打开 `nginx` 主配置文件
  ...
  ![image-20200805160257592](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152925.png)
...
![image-20200805160615360](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152933.png)
...
![image-20200807132503823](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152940.png)
...
![image-20200807133234597](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152945.png)

修改 ***运行超时秒数*** ，查找：`max_execution_time` **酌情修改为 3600s**

![image-20200807133453326](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152950.png)

修改 ***上传文件限制*** ，查找：`upload_max_filesize` **酌情修改为 2000M**

![image-20200807133741086](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619152956.png)

修改 ***运行内存限制*** ，查找：`memory_limit` **酌情修改为 2000M**

![image-20200807133917750](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619153003.png)

开启 ***文件上传*** ,查找：`file_uploads` 更改为 `On`

![image-20200807134107318](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619153007.png)
...
![image-20200807134706542](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619153012.png)
...
![image-20200805163537543](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619153018.png)
...
- 安装系统缓存 `Redis`
  ...
  ![image-20200805164115135](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619153025.png)

**redis 服务会自动运行自动添加开机启动项，省心！！！**

**编辑**​`sudo nano /etc/php/7.3/fpm/php.ini` 文件加入：

![image-20200807211906533](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619153032.png)

```
extension=redis.so#重启php-fpmsudo systemctl restart php7.3-fpm 
```

![image-20200805164305612](http://pan.whaleluo.top/api/raw/?path=/picstorage/blog/old/20210619153038.png)
